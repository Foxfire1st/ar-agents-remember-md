...
| External-memory start blocks a dirty source memory repo so refreshed onboarding and ledger updates must be committed before worktree creation.                                                                                                                                                                                                 | L317-L344                | [git_worktree_manager.py](agents-remember-md/skills/U-01-core-skills/C-09-git-worktree-manager/scripts/git_worktree_manager.py)    |
