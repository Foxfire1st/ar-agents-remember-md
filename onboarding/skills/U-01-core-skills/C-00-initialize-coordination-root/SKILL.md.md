...
| Internal and explicit coordinator settings examples keep storage and path rules under memory-layer `system/settings.json` and seed common generated/vendor/build/local excludes. | L122-L207 | [C-00 SKILL.md](agents-remember-md/skills/U-01-core-skills/C-00-initialize-coordination-root/SKILL.md) |
