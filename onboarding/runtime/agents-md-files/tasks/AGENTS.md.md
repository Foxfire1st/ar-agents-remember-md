...
| path                   | `runtime/agents-md-files/tasks/AGENTS.md`   |
...
| Finding                                                                                                              | Citations | Source Path |
| -------------------------------------------------------------------------------------------------------------------- | --------- | ----------- |
| The template covers meta-questioning, task reframing, top-down/bottom-up design philosophy, assumptions, and truth gaps. | L1-L103 | [runtime/agents-md-files/tasks/AGENTS.md](agents-remember-md/runtime/agents-md-files/tasks/AGENTS.md) |
| Evidence-first reasoning and representative examples are required when correctness depends on interpretation or risky structure. | L105-L133 | [runtime/agents-md-files/tasks/AGENTS.md](agents-remember-md/runtime/agents-md-files/tasks/AGENTS.md) |
| The visible planning standard lists the context agents should surface before non-trivial implementation.             | L136-L153 | [runtime/agents-md-files/tasks/AGENTS.md](agents-remember-md/runtime/agents-md-files/tasks/AGENTS.md) |
