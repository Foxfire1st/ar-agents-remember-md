...
| path                   | `runtime/system/defaults/examples/README.md`                |
...
`runtime/system/defaults/examples/README.md` explains why system examples are split into target-shaped folders instead of encoded through file names.
...
| Finding | Citations | Source Path |
| --- | --- | --- |
| The README states that examples are split by target folder rather than by inferred ownership from file names. | L1-L4 | [runtime/system/defaults/examples/README.md](agents-remember-md/runtime/system/defaults/examples/README.md) |
| The README defines coordinator examples as workspace-wide/global and memory-repo examples as repository-specific. | L8-L31 | [runtime/system/defaults/examples/README.md](agents-remember-md/runtime/system/defaults/examples/README.md) |
