...
| path                   | `runtime/skills/W-01-heavy-task-workflow/workflow/P-06-closure.md` |
...
This workflow document defines the W-01 closure phase.

## Notes

It captures the end-of-task handoff and memory/update expectations after implementation is complete.
