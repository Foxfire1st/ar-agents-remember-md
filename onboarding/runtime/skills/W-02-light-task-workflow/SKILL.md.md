...
| path                   | `runtime/skills/W-02-light-task-workflow/SKILL.md` |
...
| Finding | Citations | Source Path |
| --- | --- | --- |
| The skill defines the task wrapper plus `task.md` as the durable plan/checklist artifact for medium work. | L25-L36 | [W-02 SKILL.md](agents-remember-md/runtime/skills/W-02-light-task-workflow/SKILL.md) |
| Agent responsibilities include creating the wrapper artifact, stopping for implementation approval, implementing checklist items, presenting a worktree-backed commit preview, and waiting for commit approval before closeout commits. | L38-L52 | [W-02 SKILL.md](agents-remember-md/runtime/skills/W-02-light-task-workflow/SKILL.md) |
