...
| Finding                                                                                           | Citations | Source Path                                                                                         |
| ------------------------------------------------------------------------------------------------- | --------- | --------------------------------------------------------------------------------------------------- |
| The route-local overview template defines route metadata, scope, structures, flows, load-bearing files, local invariants, and traps. | L1-L54    | [route-local-overview-template.md](agents-remember-md/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/route-local-overview-template.md) |
