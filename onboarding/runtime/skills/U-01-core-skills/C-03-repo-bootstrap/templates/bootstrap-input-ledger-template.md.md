...
| path                   | `runtime/skills/U-01-core-skills/C-03-repo-bootstrap/templates/bootstrap-input-ledger-template.md`        |
...
| C-03 requires source inventory review to be written to `bootstrap/input-ledger.md` using this template before automated execution starts. | L226-L254; L548-L564 | [C-03 SKILL.md](agents-remember-md/runtime/skills/U-01-core-skills/C-03-repo-bootstrap/SKILL.md) |
