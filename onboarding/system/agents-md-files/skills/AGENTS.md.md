...
| path                   | `system/agents-md-files/skills/AGENTS.md`  |
...
C-08, missing scaffolds to C-00, stale onboarding to C-02, durable finding
...
| Finding                                                                                                             | Citations | Source Path |
| ------------------------------------------------------------------------------------------------------------------- | --------- | ----------- |
| Core-skill routing maps common memory, onboarding, discovery, lifecycle, baseline, and carryover needs to C-* IDs. | L1-L33    | [system/agents-md-files/skills/AGENTS.md](agents-remember-md/system/agents-md-files/skills/AGENTS.md) |
