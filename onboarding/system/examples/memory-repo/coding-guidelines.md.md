...
| path                   | `system/examples/memory-repo/coding-guidelines.md` |
...
| Finding | Citations | Source Path |
| --- | --- | --- |
| The example says repository-specific coding guidance belongs in the target memory root. | L1-L10 | [system/examples/memory-repo/coding-guidelines.md](agents-remember-md/system/examples/memory-repo/coding-guidelines.md) |
| The example documents compatibility and cleanup rules for memory-layer coding guidance. | L12-L37 | [system/examples/memory-repo/coding-guidelines.md](agents-remember-md/system/examples/memory-repo/coding-guidelines.md) |
