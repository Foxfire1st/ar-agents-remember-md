...
`README.md` is the public-facing explanation of Agents Remember. It explains one-to-one onboarding, setup, harness skill installation, storage modes, coordination roots, resolver and drift-check roles, and the repository's skill layout.
