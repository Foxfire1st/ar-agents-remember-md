...
- This catalog treats `runtime/agents-md-files/` as the package source for runtime `AGENTS.md` templates, while memory-repo `AGENTS.md` files remain memory-repo-owned.
