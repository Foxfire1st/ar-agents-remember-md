...
| --- | --- | --- | --- |
| Onboarding Unit | `git-blob-set-v1` | `sha256:d1db2e713f94b93888fe6aebec8925c80ad2bdd5c35ddaeca6cf4a578b47d2cd` | `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/SKILL.md`; `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/workflows/file-level-onboarding-workflow.md`; `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/workflows/repo-entity-catalog-workflow.md`; `runtime/skills/U-01-core-skills/C-02-onboarding-drift-detection/scripts/check_onboarding_drift.py` |
| Runtime AGENTS Template Package | `git-blob-set-v1` | `sha256:fbde82738039bc7599330a8a0f6bdec457f01d5e2d6ed786766e33dcbcb7891d` | `runtime/agents-md-files/coordinator/AGENTS.md`; `runtime/agents-md-files/skills/AGENTS.md`; `runtime/agents-md-files/system/AGENTS.md`; `runtime/agents-md-files/tasks/AGENTS.md`; `installer/install-runtime.py` |
| Coordination Context | `git-blob-set-v1` | `sha256:866e02f22ce6cc5e8db4bdfbfb36490bbca409ff952e7008f5813e9b0c8836ee` | `runtime/skills/U-01-core-skills/C-08-ar-coordination-context-resolver/SKILL.md`; `runtime/skills/U-01-core-skills/C-08-ar-coordination-context-resolver/scripts/ar_coordination_context_resolver.py` |
| Path Rule | `git-blob-set-v1` | `sha256:47eee53f90081a64425cb6cbf134cd6ea399261816eb7554dd141f38ac48713c` | `runtime/skills/U-01-core-skills/C-08-ar-coordination-context-resolver/scripts/ar_coordination_context_resolver.py`; `runtime/system/defaults/examples/memory-repo/settings.json`; `runtime/system/defaults/examples/coordinator/settings.json` |
| Drift Report | `git-blob-set-v1` | `sha256:ab34a2605b6969ce23e22dfa0b5614098de31dcfa9a0d4470cb32c19aa4d5566` | `runtime/skills/U-01-core-skills/C-02-onboarding-drift-detection/SKILL.md`; `runtime/skills/U-01-core-skills/C-02-onboarding-drift-detection/scripts/check_onboarding_drift.py` |
| File-Level Onboarding Content Model | `git-blob-set-v1` | `sha256:9cf3b507e0b72363f30d5ad20125e02d91578cc2dad05f1aeeae6f1ac3c5b94d` | `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/SKILL.md`; `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/workflows/file-level-onboarding-workflow.md`; `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/templates/file-level-onboarding-template.md`; `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/templates/inline-onboarding-block-template.md` |
...
| External Memory Ledger | `git-blob-set-v1` | `sha256:925e15aca22f2721cc3b24de66a8b40ad2329ab500ef6ae293eef30106e4f6c2` | `runtime/skills/U-01-core-skills/_shared/agents_remember/memory_ledger.py`; `runtime/skills/U-01-core-skills/C-09-git-worktree-manager/scripts/git_worktree_manager.py`; `runtime/skills/U-01-core-skills/C-10-adopt-memory-baseline/scripts/adopt_memory_baseline.py` |
| Memory Baseline Adoption | `git-blob-set-v1` | `sha256:5a9ac7919f265370381b63bf8792016f8c46fd5aa1f8bb0cb0324444f03ad972` | `runtime/skills/U-01-core-skills/C-10-adopt-memory-baseline/SKILL.md`; `runtime/skills/U-01-core-skills/C-10-adopt-memory-baseline/scripts/adopt_memory_baseline.py` |
| Worktree Contract | `git-blob-set-v1` | `sha256:24e6d2ef28479939fa62db0dc6792aeb0b6cc3dd85d99934b98b668f24d5aea9` | `runtime/skills/U-01-core-skills/_shared/agents_remember/worktree_contract.py`; `runtime/skills/U-01-core-skills/C-09-git-worktree-manager/SKILL.md`; `runtime/skills/U-01-core-skills/C-09-git-worktree-manager/scripts/git_worktree_manager.py` |
| Worktree Integration | `git-blob-set-v1` | `sha256:698866ddfa3fa60d32bac4f6c01a206efeae223f8c7509cf20ba7e89238cbb0c` | `runtime/skills/U-01-core-skills/C-09-git-worktree-manager/SKILL.md`; `runtime/skills/U-01-core-skills/C-09-git-worktree-manager/scripts/git_worktree_manager.py` |
| Branch-Gated Cross-Repo Source | `git-blob-set-v1` | `sha256:866e02f22ce6cc5e8db4bdfbfb36490bbca409ff952e7008f5813e9b0c8836ee` | `runtime/skills/U-01-core-skills/C-08-ar-coordination-context-resolver/SKILL.md`; `runtime/skills/U-01-core-skills/C-08-ar-coordination-context-resolver/scripts/ar_coordination_context_resolver.py` |
...
| Description                  | File-level onboarding mirrors one concrete source file; overviews summarize repo or route scopes; repo-level catalogs document recurring entities, carry deterministic evidence fingerprints, and require one fingerprint row per inventory entity.                                                                                  |
...
| Source References            | [README.md](agents-remember-md/README.md) L57-L61; [C-05 SKILL.md](agents-remember-md/runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/SKILL.md) L21-L33; [file-level workflow](agents-remember-md/runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/workflows/file-level-onboarding-workflow.md) L28-L59 |
...
| Description                  | The current package lives under `runtime/agents-md-files/` and contains four templates: `coordinator/AGENTS.md`, `skills/AGENTS.md`, `system/AGENTS.md`, and `tasks/AGENTS.md`.                                                                                                                                                                                                                                            |
| Canonical Source Of Truth    | The four source templates under `runtime/agents-md-files/` and their file-level onboarding units.                                                                                                                                                                                                                                                                                                                    |
| Current Naming Drift         | No `workflow` or memory-repo `AGENTS.md` template exists after the shuffle; memory repos are not expected to provide root-level `AGENTS.md` files and use `system/*` files for repo-specific guidance.                                                                                                                                                                                                                  |
| Key Identifiers              | Source paths under `runtime/agents-md-files/`; intended installed destinations `ar-coordination/AGENTS.md`, `ar-coordination/skills/AGENTS.md`, `ar-coordination/system/AGENTS.md`, and `ar-coordination/tasks/AGENTS.md`.                                                                                                                                                                                           |
| Parent / Child Relationships | Complements `runtime/system/defaults/examples/` fixtures and `installer/install-runtime.py`; file-level onboarding mirrors each of the four templates.                                                                                                                                                                                                                 |
...
| Source References            | [coordinator template](agents-remember-md/runtime/agents-md-files/coordinator/AGENTS.md) L3-L85; [skills template](agents-remember-md/runtime/agents-md-files/skills/AGENTS.md) L1-L33; [system template](agents-remember-md/runtime/agents-md-files/system/AGENTS.md) L1-L68; [tasks template](agents-remember-md/runtime/agents-md-files/tasks/AGENTS.md) L1-L153 |
...
| Source References            | [C-08 SKILL.md](agents-remember-md/runtime/skills/U-01-core-skills/C-08-ar-coordination-context-resolver/SKILL.md) L24-L43; [ar_coordination_context_resolver.py](agents-remember-md/runtime/skills/U-01-core-skills/C-08-ar-coordination-context-resolver/scripts/ar_coordination_context_resolver.py) L87-L111; L1087-L1147; L1216-L1264 |
...
| Source References            | [README.md](agents-remember-md/README.md) L122-L135; [ar_coordination_context_resolver.py](agents-remember-md/runtime/skills/U-01-core-skills/C-08-ar-coordination-context-resolver/scripts/ar_coordination_context_resolver.py) L249-L259; L585-L610 |
...
| Represents In Reality        | C-02's report of onboarding trust against source-file metadata, overview source-route metadata, inline digests, and entity catalog fingerprint coverage.                                                                                                                                                  |
| Description                  | Drift reports classify onboarding units as up to date, drifted, missing verification, missing, orphaned, disabled, or unsupported and are written under the resolved temporary artifact root by default. Entity catalogs can produce one row per entity fingerprint, inventory entry without a fingerprint row, or orphaned fingerprint row. |
...
| Key Identifiers              | report path, `classification`, `trust`, onboarding file path, source file path or `entity:<name>`, affected sections, note. Missing entity fingerprint rows use `missing verification`; fingerprint rows without inventory entries use `orphaned`.                                                       |
...
| Source References            | [C-02 SKILL.md](agents-remember-md/runtime/skills/U-01-core-skills/C-02-onboarding-drift-detection/SKILL.md) L16-L21; L62-L66; L99-L114; L153-L177; [check_onboarding_drift.py](agents-remember-md/runtime/skills/U-01-core-skills/C-02-onboarding-drift-detection/scripts/check_onboarding_drift.py) L69-L80; L337-L441; L467-L789; L1086-L1160 |
...
| Source References            | [file-level workflow](agents-remember-md/runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/workflows/file-level-onboarding-workflow.md) L48-L82; [C-05 SKILL.md](agents-remember-md/runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/SKILL.md) L58-L74 |
...
| Source References            | [W-02 SKILL.md](agents-remember-md/runtime/skills/W-02-light-task-workflow/SKILL.md) L25-L34; [workflow.md](agents-remember-md/runtime/skills/W-02-light-task-workflow/workflow.md) L101-L139; [template.md](agents-remember-md/runtime/skills/W-02-light-task-workflow/template.md) L8-L86 |
...
| Source References            | [C-10 SKILL.md](agents-remember-md/runtime/skills/U-01-core-skills/C-10-adopt-memory-baseline/SKILL.md) L8-L28; [adopt_memory_baseline.py](agents-remember-md/runtime/skills/U-01-core-skills/C-10-adopt-memory-baseline/scripts/adopt_memory_baseline.py) L53-L78; L138-L176 |
...
| Source References            | [worktree_contract.py](agents-remember-md/runtime/skills/U-01-core-skills/_shared/agents_remember/worktree_contract.py) L16-L58; L211-L225; [git_worktree_manager.py](agents-remember-md/runtime/skills/U-01-core-skills/C-09-git-worktree-manager/scripts/git_worktree_manager.py) L560-L654 |
...
| Source References            | [C-09 SKILL.md](agents-remember-md/runtime/skills/U-01-core-skills/C-09-git-worktree-manager/SKILL.md) L53-L70; [git_worktree_manager.py](agents-remember-md/runtime/skills/U-01-core-skills/C-09-git-worktree-manager/scripts/git_worktree_manager.py) L560-L654                                  |
...
| Layer              | Representation                                                                                                                       |
| ------------------ | ------------------------------------------------------------------------------------------------------------------------------------ |
| Repository source  | Four templates under `runtime/agents-md-files/{coordinator,skills,system,tasks}/AGENTS.md`.                                           |
| Runtime install    | Intended destinations under the coordinator root, skills tree, system tree, and task tree.                                           |
| Onboarding storage | Four mirrored file-level onboarding units under `onboarding/runtime/agents-md-files/`.                                                |
...
- This catalog treats `runtime/agents-md-files/` as the package source for runtime `AGENTS.md` templates. Memory repos use `system/*` guidance files rather than root-level `AGENTS.md` files.
...
- 2026-05-15T00:38+02:00: Added the runtime `AGENTS.md` template package entity after the source templates were consolidated under `runtime/agents-md-files/`.
