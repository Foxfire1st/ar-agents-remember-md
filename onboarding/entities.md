...
| lastUpdated | 2026-05-15T12:23+02:00 |
| status      | active                |
...
Each row records the deterministic source evidence used by C-02 for entity drift detection. The `git-blob-set-v1` fingerprint sorts the evidence paths, resolves each current `HEAD:<path>` Git blob hash, and hashes the resulting `path + blob_hash` list. A changed fingerprint means the entity entry needs review; it does not automatically prove the prose is wrong.

| Entity | Algorithm | Fingerprint | Evidence Paths |
| --- | --- | --- | --- |
| Onboarding Unit | `git-blob-set-v1` | `sha256:f9156bd63efc4074c22019c8921ca497323e8460f5a1bd3df9dcf0e5b2f18cdb` | `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/SKILL.md`; `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/workflows/file-level-onboarding-workflow.md`; `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/workflows/repo-entity-catalog-workflow.md`; `runtime/skills/U-01-core-skills/C-02-onboarding-drift-detection/scripts/check_onboarding_drift.py` |
...
| Drift Report | `git-blob-set-v1` | `sha256:a2ef773265e1c0a8b92bca94da23b4a7b6dfae645348e0d637e923c13e69600c` | `runtime/skills/U-01-core-skills/C-02-onboarding-drift-detection/SKILL.md`; `runtime/skills/U-01-core-skills/C-02-onboarding-drift-detection/scripts/check_onboarding_drift.py` |
| File-Level Onboarding Content Model | `git-blob-set-v1` | `sha256:6ea7846a409494d0ffa8297af38f78e60a4e62e165911b3d76295c5863351e85` | `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/SKILL.md`; `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/workflows/file-level-onboarding-workflow.md`; `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/templates/file-level-onboarding-template.md`; `runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/templates/inline-onboarding-block-template.md` |
...
| Description                  | File-level onboarding mirrors one concrete source file; overviews summarize repo or route scopes; repo-level catalogs document recurring entities and carry deterministic evidence fingerprints.                                                                                                                                      |
...
| Represents In Reality        | C-02's report of onboarding trust against source-file metadata, overview source-route metadata, inline digests, and entity evidence fingerprints.                                                                                                                                                         |
| Description                  | Drift reports classify onboarding units as up to date, drifted, missing verification, missing, orphaned, disabled, or unsupported and are written under the resolved temporary artifact root by default. Entity catalogs can produce one row per entity fingerprint. |
...
| Key Identifiers              | report path, `classification`, `trust`, onboarding file path, source file path or `entity:<name>`, affected sections, note.                                                                                                                                                                              |
...
| Source References            | [C-02 SKILL.md](agents-remember-md/runtime/skills/U-01-core-skills/C-02-onboarding-drift-detection/SKILL.md) L16-L21; L62-L66; L98-L130; [check_onboarding_drift.py](agents-remember-md/runtime/skills/U-01-core-skills/C-02-onboarding-drift-detection/scripts/check_onboarding_drift.py) L69-L80; L337-L441; L444-L673; L970-L1044 |
...
| Source References            | [file-level workflow](agents-remember-md/runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/workflows/file-level-onboarding-workflow.md) L48-L82; [C-05 SKILL.md](agents-remember-md/runtime/skills/U-01-core-skills/C-05-create-or-update-onboarding-files/SKILL.md) L51-L64 |
